 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(e){function t(P,N){var L=P.length;P.push(N);e:for(;0<L;){var Z=L-1>>>1,ae=P[Z];if(0<i(ae,N))P[Z]=N,P[L]=ae,L=Z;else break e}}function n(P){return P.length===0?null:P[0]}function r(P){if(P.length===0)return null;var N=P[0],L=P.pop();if(L!==N){P[0]=L;e:for(var Z=0,ae=P.length,Li=ae>>>1;Z<Li;){var Jt=2*(Z+1)-1,Uo=P[Jt],Zt=Jt+1,Di=P[Zt];if(0>i(Uo,L))Zt<ae&&0>i(Di,Uo)?(P[Z]=Di,P[Zt]=L,Z=Zt):(P[Z]=Uo,P[Jt]=L,Z=Jt);else if(Zt<ae&&0>i(Di,L))P[Z]=Di,P[Zt]=L,Z=Zt;else break e}}return N}function i(P,N){var L=P.sortIndex-N.sortIndex;return L!==0?L:P.id-N.id}if(typeof performance=="object"&&typeof performance.now=="function"){var a=performance;e.unstable_now=function(){return a.now()}}else{var o=Date,s=o.now();e.unstable_now=function(){return o.now()-s}}var l=[],u=[],c=1,d=null,p=3,g=!1,w=!1,y=!1,S=typeof setTimeout=="function"?setTimeout:null,h=typeof clearTimeout=="function"?clearTimeout:null,f=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function m(P){for(var N=n(u);N!==null;){if(N.callback===null)r(u);else if(N.startTime<=P)r(u),N.sortIndex=N.expirationTime,t(l,N);else break;N=n(u)}}function v(P){if(y=!1,m(P),!w)if(n(l)!==null)w=!0,Do(k);else{var N=n(u);N!==null&&Mo(v,N.startTime-P)}}function k(P,N){w=!1,y&&(y=!1,h(b),b=-1),g=!0;var L=p;try{for(m(N),d=n(l);d!==null&&(!(d.expirationTime>N)||P&&!ze());){var Z=d.callback;if(typeof Z=="function"){d.callback=null,p=d.priorityLevel;var ae=Z(d.expirationTime<=N);N=e.unstable_now(),typeof ae=="function"?d.callback=ae:d===n(l)&&r(l),m(N)}else r(l);d=n(l)}if(d!==null)var Li=!0;else{var Jt=n(u);Jt!==null&&Mo(v,Jt.startTime-N),Li=!1}return Li}finally{d=null,p=L,g=!1}}var E=!1,I=null,b=-1,U=5,R=-1;function ze(){return!(e.unstable_now()-R<U)}function vr(){if(I!==null){var P=e.unstable_now();R=P;var N=!0;try{N=I(!0,P)}finally{N?yr():(E=!1,I=null)}}else E=!1}var yr;if(typeof f=="function")yr=function(){f(vr)};else if(typeof MessageChannel<"u"){var rc=new MessageChannel,sg=rc.port2;rc.port1.onmessage=vr,yr=function(){sg.postMessage(null)}}else yr=function(){S(vr,0)};function Do(P){I=P,E||(E=!0,yr())}function Mo(P,N){b=S(function(){P(e.unstable_now())},N)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(P){P.callback=null},e.unstable_continueExecution=function(){w||g||(w=!0,Do(k))},e.unstable_forceFrameRate=function(P){0>P||125<P?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):U=0<P?Math.floor(1e3/P):5},e.unstable_getCurrentPriorityLevel=function(){return p},e.unstable_getFirstCallbackNode=function(){return n(l)},e.unstable_next=function(P){switch(p){case 1:case 2:case 3:var N=3;break;default:N=p}var L=p;p=N;try{return P()}finally{p=L}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function(P,N){switch(P){case 1:case 2:case 3:case 4:case 5:break;default:P=3}var L=p;p=P;try{return N()}finally{p=L}},e.unstable_scheduleCallback=function(P,N,L){var Z=e.unstable_now();switch(typeof L=="object"&&L!==null?(L=L.delay,L=typeof L=="number"&&0<L?Z+L:Z):L=Z,P){case 1:var ae=-1;break;case 2:ae=250;break;case 5:ae=1073741823;break;case 4:ae=1e4;break;default:ae=5e3}return ae=L+ae,P={id:c++,callback:N,priorityLevel:P,startTime:L,expirationTime:ae,sortIndex:-1},L>Z?(P.sortIndex=L,t(u,P),n(l)===null&&P===n(u)&&(y?(h(b),b=-1):y=!0,Mo(v,L-Z))):(P.sortIndex=ae,t(l,P),w||g||(w=!0,Do(k))),P},e.unstable_shouldYield=ze,e.unstable_wrapCallback=function(P){var N=p;return function(){var L=p;p=N;try{return P.apply(this,arguments)}finally{p=L}}}})(Od);Ad.exports=Od;var Og=Ad.exports;/**
 * @license React
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function me(){return typeof navigator<"u"&&typeof navigator.userAgent=="string"?navigator.userAgent:""}function Vy(){return typeof window<"u"&&!!(window.cordova||window.phonegap||window.PhoneGap)&&/ios|iphone|ipod|ipad|android|blackberry|iemobile/i.test(me())}function Wy(){const e=typeof chrome=="object"?chrome.runtime:typeof browser=="object"?browser.runtime:void 0;return typeof e=="object"&&e.id!==void 0}function Yy(){return typeof navigator=="object"&&navigator.product==="ReactNative"}function Ky(){const e=me();return e.indexOf("MSIE ")>=0||e.indexOf("Trident/")>=0}function Gy(){try{return typeof indexedDB=="object"}catch{return!1}}function Qy(){return new Promise((e,t)=>{try{let n=!0;const r="validate-browser-context-for-indexeddb-analytics-module",i=self.indexedDB.open(r);i.onsuccess=()=>{i.result.close(),n||self.indexedDB.deleteDatabase(r),e(!0)},i.onupgradeneeded=()=>{n=!1},i.onerror=()=>{var a;t(((a=i.error)===null||a===void 0?void 0:a.message)||"")}}catch(n){t(n)}})}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function p1(){return typeof navigator<"u"&&navigator&&"onLine"in navigator&&typeof navigator.onLine=="boolean"&&(h1()||Wy()||"connection"in navigator)?navigator.onLine:!0}function m1(){if(typeof navigator>"u")return null;const e=navigator;return e.languages&&e.languages[0]||e.language||null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Pi{constructor(t,n){this.shortDelay=t,this.longDelay=n,ht(n>t,"Short delay should be less than long delay!"),this.isMobile=Vy()||Yy()}get(){return p1()?this.isMobile?this.longDelay:this.shortDelay:Math.min(5e3,this.shortDelay)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Vw=new Pi(3e4,6e4);function Rf(){const e=tt().___jsl;if(e!=null&&e.H){for(const t of Object.keys(e.H))if(e.H[t].r=e.H[t].r||[],e.H[t].L=e.H[t].L||[],e.H[t].r=[...e.H[t].L],e.CP)for(let n=0;n<e.CP.length;n++)e.CP[n]=null}}function Ww(e){return new Promise((t,n)=>{var r,i,a;function o(){Rf(),gapi.load("gapi.iframes",{callback:()=>{t(gapi.iframes.getContext())},ontimeout:()=>{Rf(),n(et(e,"network-request-failed"))},timeout:Vw.get()})}if(!((i=(r=tt().gapi)===null||r===void 0?void 0:r.iframes)===null||i===void 0)&&i.Iframe)t(gapi.iframes.getContext());else if(!((a=tt().gapi)===null||a===void 0)&&a.load)o();else{const s=F1("iframefcb");return tt()[s]=()=>{gapi.load?o():n(et(e,"network-request-failed"))},om(`https://apis.google.com/js/api.js?onload=${s}`).catch(l=>n(l))}}).catch(t=>{throw Ia=null,t})}let Ia=null;function Yw(e){return Ia=Ia||Ww(e),Ia}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 *
 * @license MIT
 */const N_="startTransition",Bf=Ig[N_];function R_(e){let{basename:t,children:n,future:r,window:i}=e,a=F.useRef();a.current==null&&(a.current=I_({window:i,v5Compat:!0}));let o=a.current,[s,l]=F.useState({action:o.action,location:o.location}),{v7_startTransition:u}=r||{},c=F.useCallback(d=>{u&&Bf?Bf(()=>l(d)):l(d)},[l,u]);return F.useLayoutEffect(()=>o.listen(c),[o,c]),F.createElement(O_,{basename:t,children:n,location:s.location,navigationType:s.action,navigator:o})}var Hf;(function(e){e.UseScrollRestoration="useScrollRestoration",e.UseSubmit="useSubmit",e.UseSubmitFetcher="useSubmitFetcher",e.UseFetcher="useFetcher"})(Hf||(Hf={}));var Vf;(function(e){e.UseFetchers="useFetchers",e.UseScrollRestoration="useScrollRestoration"})(Vf||(Vf={}));const L_=({setShowSignUp:e,showSignUp:t})=>{const[n,r]=F.useState(""),[i,a]=F.useState(""),[o,s]=F.useState(null),l=async c=>{c.preventDefault();try{await aw(Sm,n,i),console.log("Successfully Signed In"),s(null)}catch(d){console.log("Error signing in: ",d),console.log(d.message),s(u(d.code))}},u=c=>({"auth/invalid-email":"Invalid Email!","auth/invalid-login-credentials":"Incorrect Password!","auth/user-not-found":"User not found, Please check your Email!"})[c]||"There is an problem";return O.jsxs("div",{className:"w-80% bg-light-yellow rounded-full px-5",children:[O.jsxs("form",{name:"signin",onSubmit:l,children:[O.jsx("input",{type:"email",placeholder:"Email",value:n,onChange:c=>{r(c.target.value)}}),O.jsx("input",{type:"password",placeholder:"Password",value:i,onChange:c=>{a(c.target.value)}}),O.jsx("button",{type:"submit",children:"Sign In"})]}),o&&O.jsx("p",{children:o}),O.jsx("p",{className:"cursor-pointer",onClick:()=>e(!t),children:"Don't have an account?"})]})},D_=({setShowSignUp:e,showSignUp:t})=>{const[n,r]=F.useState(""),[i,a]=F.useState(""),[o,s]=F.useState(!0),[l,u]=F.useState(!0),[c,d]=F.useState(null),p=async y=>{y.preventDefault();try{o&&l&&(await iw(Sm,n,i),d(null),console.log("Signed Up Successfully"))}catch(S){d(S.message),console.log("Error Signing Up: ",S)}},g=y=>{const S=/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(y);s(S)},w=y=>{const S=y.length>=8;u(S)};return O.jsxs("div",{className:"w-80% bg-light-yellow rounded-full px-5",children:[O.jsxs("form",{name:"signup",onSubmit:p,children:[O.jsx("input",{type:"email",value:n,placeholder:"Email",onChange:y=>{r(y.target.value),g(y.target.value)}}),!o&&O.jsx("p",{children:"Please, Enter valid Email!"}),O.jsx("input",{type:"password",value:i,placeholder:"Password",onChange:y=>{a(y.target.value),w(y.target.value)}}),!l&&O.jsx("p",{children:"Password must be atleast 8 characters!"}),O.jsx("button",{type:"submit",children:"Sign Up"})]}),O.jsx("p",{className:"cursor-pointer",onClick:()=>e(!t),children:"Already have an account?"})]})},M_=({todo:e,setTodo:t,todos:n,setTodos:r})=>{const[i,a]=F.useState(!1),[o,s]=F.useState(!1),l=u=>{u.preventDefault();const c={text:e,checked:!1};e!==""&&(r([...n,c]),t(""))};return O.jsx("header",{id:"header",className:"font-poppins_regular bg-dark-green pt-[100px] pb-[40px] flex justify-center",children:O.jsxs("div",{className:"w-[450px] max-sm:padding-x",children:[O.jsxs("h1",{className:"text-white font-poppins_semibold text-3xl left-0 mb-2",children:["Todo",O.jsx("span",{className:"font-poppins_extralight",children:"App"})]}),i?O.jsxs("form",{onSubmit:l,className:"flex gap-4 max-sm:flex-col",children:[O.jsx("input",{type:"text",value:e,onChange:u=>t(u.target.value),placeholder:"Eg: Read Books",className:"bg-light-yellow placeholder:text-yellow-900 px-5 text-sm rounded-full shadow-md h-10 w-[80%] max-sm:w-[100%]"}),O.jsx("button",{type:"submit",className:"bg-white font-poppins_semibold text-sm w-28 max-sm:w-full h-10  rounded-full shadow-md",children:"Add Task"})]}):o?O.jsx(D_,{setShowSignUp:s,showSignUp:o}):O.jsx(L_,{setShowSignUp:s,showSignUp:o})]})})};var U_={prefix:"far",iconName:"circle",icon:[512,512,[128308,128309,128992,128993,128994,128995,128996,9679,9898,9899,11044,61708,61915],"f111","M464 256A208 208 0 1 0 48 256a208 208 0 1 0 416 0zM0 256a256 256 0 1 1 512 0A256 256 0 1 1 0 256z"]},z_={prefix:"far",iconName:"circle-xmark",icon:[512,512,[61532,"times-circle","xmark-circle"],"f057","M256 48a208 208 0 1 1 0 416 208 208 0 1 1 0-416zm0 464A256 256 0 1 0 256 0a256 256 0 1 0 0 512zM175 175c-9.4 9.4-9.4 24.6 0 33.9l47 47-47 47c-9.4 9.4-9.4 24.6 0 33.9s24.6 9.4 33.9 0l47-47 47 47c9.4 9.4 24.6 9.4 33.9 0s9.4-24.6 0-33.9l-47-47 47-47c9.4-9.4 9.4-24.6 0-33.9s-24.6-9.4-33.9 0l-47 47-47-47c-9.4-9.4-24.6-9.4-33.9 0z"]},F_={prefix:"fas",iconName:"circle-check",icon:[512,512,[61533,"check-circle"],"f058","M256 512A256 256 0 1 0 256 0a256 256 0 1 0 0 512zM369 209L241 337c-9.4 9.4-24.6 9.4-33.9 0l-64-64c-9.4-9.4-9.4-24.6 0-33.9s24.6-9.4 33.9 0l47 47L335 175c9.4-9.4 24.6-9.4 33.9 0s9.4 24.6 0 33.9z"]};function Wf(e,t){var n=Object.keys(e);if(Object.getOwnPropertySymbols){var r=Object.getOwnPropertySymbols(e);t&&(r=r.filter(function(i){return Object.getOwnPropertyDescriptor(e,i).enumerable})),n.push.apply(n,r)}return n}function C(e){for(var t=1;t<arguments.length;t++){var n=arguments[t]!=null?arguments[t]:{};t%2?Wf(Object(n),!0).forEach(function(r){ie(e,r,n[r])}):Object.getOwnPropertyDescriptors?Object.defineProperties(e,Object.getOwnPropertyDescriptors(n)):Wf(Object(n)).forEach(function(r){Object.defineProperty(e,r,Object.getOwnPropertyDescriptor(n,r))})}return e}function oo(e){"@babel/helpers - typeof";return oo=typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?function(t){return typeof t}:function(t){return t&&typeof Symbol=="function"&&t.constructor===Symbol&&t!==Symbol.prototype?"symbol":typeof t},oo(e)}function j_(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function Yf(e,t){for(var n=0;n<t.length;n++){var r=t[n];r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(e,r.key,r)}}function $_(e,t,n){return t&&Yf(e.prototype,t),n&&Yf(e,n),Object.defineProperty(e,"prototype",{writable:!1}),e}function ie(e,t,n){return t in e?Object.defineProperty(e,t,{value:n,enumerable:!0,configurable:!0,writable:!0}):e[t]=n,e}function Vu(e,t){return H_(e)||W_(e,t)||xm(e,t)||K_()}function Oi(e){return B_(e)||V_(e)||xm(e)||Y_()}function B_(e){if(Array.isArray(e))return Cl(e)}function H_(e){if(Array.isArray(e))return e}function V_(e){if(typeof Symbol<"u"&&e[Symbol.iterator]!=null||e["@@iterator"]!=null)return Array.from(e)}function W_(e,t){var n=e==null?null:typeof Symbol<"u"&&e[Symbol.iterator]||e["@@iterator"];if(n!=null){var r=[],i=!0,a=!1,o,s;try{for(n=n.call(e);!(i=(o=n.next()).done)&&(r.push(o.value),!(t&&r.length===t));i=!0);}catch(l){a=!0,s=l}finally{try{!i&&n.return!=null&&n.return()}finally{if(a)throw s}}return r}}function xm(e,t){if(e){if(typeof e=="string")return Cl(e,t);var n=Object.prototype.toString.call(e).slice(8,-1);if(n==="Object"&&e.constructor&&(n=e.constructor.name),n==="Map"||n==="Set")return Array.from(e);if(n==="Arguments"||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n))return Cl(e,t)}}function Cl(e,t){(t==null||t>e.length)&&(t=e.length);for(var n=0,r=new Array(t);n<t;n++)r[n]=e[n];return r}function Y_(){throw new TypeError(`Invalid attempt to spread non-iterable instance.
